...
export class GameOver extends Scene {
    ...
    create(data: any) {
        ...
        this.add.text(800, 150, totalScore.toString(), { font: '28px Arial' }).setOrigin(1, 0);
        ...
        actionsTaken.forEach((action: any, index: number) => {
            ...
            this.add.text(800, yPosition, action.points.toString(), { font: '20px Arial' }).setOrigin(1, 0);
        });
